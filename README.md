...
- [Checklist](#Checklist)
  - [INFORMATION GATHERING](#INFORMATION-GATHERING)
  - [CLIENT SIDE ATTACKS](#CLIENT-SIDE-ATTACKS)
    - [FILE TESTING + Binary Analysis](#FILE-TESTING-+-Binary-Analysis)
      - [Test For Files Permission](#Test-For-Files-Permission)
      - [Test For File Continuity](#Test-For-File-Continuity)
      - [Test For File Content Debugging](#Test-For-File-Content-Debugging)
      - [Test For File And Content Manipulation](#Test-For-File-And-Content-Manipulation)
      - [Test For Function Exported](#Test-For-Function-Exported)
      - [Test For Public Methods](#Test-For-Public-Methods)
      - [Test For Decompile And Application Rebuild](#Test-For-Decompile-And-Application-Rebuild)
      - [Test For Decryption And DE obfuscation](#Test-For-Decryption-And-DE-obfuscation)
      - [Test For Disassemble and Reassemble](#Test-For-Disassemble-and-Reassemble)
    - [MEMORY TESTING](#MEMORY-TESTING)
      - [Test For Memory Content](#Test-For-Memory-Content)
      - [Test For Memory Manipulation](#Test-For-Memory-Manipulation)
      - [Test For Run Time Manipulation](#Test-For-Run-Time-Manipulation)
    - [REGISTRY TESTING](#REGISTRY-TESTING)
      - [Test For Registry Permissions](#Test-For-Registry-Permissions)
      - [Test For Registry Contents](#Test-For-Registry-Contents)
      - [Test For Registry Manipulation](#Test-For-Registry-Manipulation)
    - [ASSEMBLY TESTING](#ASSEMBLY-TESTING)
      - [Test For Assembly*](#Test-For-Assembly*)
    - [GUI TESTING](#GUI-TESTING)
      - [Test For GUI Object Permission](#Test-For-GUI-Object-Permission)
      - [Test GUI Content](#Test-GUI-Content)
    - [DLL HIJACKING](#DLL-HIJACKING)
  - [NETWORK SIDE ATTACKS](#NETWORK-SIDE-ATTACKS)
    - [NETWORK TESTING](#NETWORK-TESTING)
    - [TRAFFIC TESTING](#TRAFFIC-TESTING)
  - [SERVER SIDE ATTACKS](#SERVER-SIDE-ATTACKS)
    - [COMMON VULNERABILITIES TESTING](#COMMON-VULNERABILITIES-TESTING)
...
- [ ] Look for Hard Coded encryption data 
...
##### Test GUI Content
- [ ] Look for sensitive information Test For GUI Logic
...
- [ ] Test for WCF Traffic and proxy them
